...
/**
 * Output the path of a node to the log
 */
...
//Start snippet to fill nodes with dump
// var res = '';
//
...
/**
 * Check if a data node exists and is not empty
...
/**
 * Inserting a node into the data model
 * @param intoNode
 * @param asNode
 * @param aValue
 * @returns
